...
for i in range(Num):
    ...
    if i==0:
        ...
        S22L.append(S22Data)
        odb.close()
pickle.dump(S22L,record)
pickle.dump(DoRL,record)
pickle.dump(ForceL,record)
record.close()