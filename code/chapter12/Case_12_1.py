...
s.Line(point1=(0.0, 0.0), point2=(beamL, 0.0))
...
mdb.models['Model-1'].RectangularProfile(name='Profile-1', a=beamA, b=beamB)
...
mdb.models['Model-1'].ConcentratedForce(name='Load-1', createStepName='Step-1', 
    region=region, cf2=CForce, distributionType=UNIFORM, field='', 
    localCsys=None)
...
#: The model database has been saved to "D:\00_workspace\00_Abaqus\Chapter12\CAE_12_1_beam.cae".
